...
with open("c:\\Users\\MSI\\Desktop\\2022-2023\\PyBlockChain\\blockchain-python-tutorial\\manifacturer_client\\private_data.json") as f:
...
def get_json():
    with open('c:\\Users\\MSI\\Desktop\\2022-2023\\PyBlockChain\\blockchain-python-tutorial\\manifacturer_client\\private_data.json', 'r') as f:
        data = json.load(f)
    return jsonify(data)
...
def get_qr_code():
    ...
    code = json_data["code"]
    with open('c:\\Users\\MSI\\Desktop\\2022-2023\\PyBlockChain\\blockchain-python-tutorial\\manifacturer_client\\templates\\qr_temp.json', 'w') as json_file:
